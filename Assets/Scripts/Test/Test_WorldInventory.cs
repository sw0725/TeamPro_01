...
public class Test_WorldInventory : TestBase
{
    ...
    {
        // 추가
        invenWorld.AddItem(code, fromIndex);
        invenWorld.Test_InventoryPrint();
    }
    ...
    {
        // 삭제
        invenWorld.RemoveItem(fromIndex);
        invenWorld.Test_InventoryPrint();
    }
    ...
    {
        // 이동
        invenWorld.FindItem(ItemType.Key);
    }
